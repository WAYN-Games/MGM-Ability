...
{/*
    ...
    public struct AbilityUICommand : ICommand
    {
        ...
        public void Execute()
        {
            ...
            DynamicBuffer<AbilityBufferElement> abbilities = _entityManager.GetBuffer<AbilityBufferElement>(_owner);
    ...
    class AbilityUIElement : VisualElement
{
    ...
    public void UpdateCoolDown()
    {
        ...
        (float, float) remainingTime = _command._entityManager.GetBuffer<AbilityBufferElement>(_command._owner)[_command._index].Ability.CoolDown.ComputeRemainingTime();
