...
<root>
  ...
  ├── Editor
  │   ├── WaynGroup.MgmEvent.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── WaynGroup.MgmEvent.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── WaynGroup.MgmEvent.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── WaynGroup.MgmEvent.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `WaynGroup.MgmEvent`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package MGM Event Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/WaynGroup.MgmEvent.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/WaynGroup.MgmEvent.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/WaynGroup.MgmEvent.Editor.Tests.asmdef`

  `Tests/Runtime/WaynGroup.MgmEvent.Tests.asmdef`
...
Use the `Documentations~/MGM Event.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
