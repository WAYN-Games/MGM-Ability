...
namespace WaynGroup.Mgm.Ability
{
        ...
        where EFFECT_CTX : struct, IEffectContext<EFFECT>
    {
        ...
        /// </summary>
        protected NativeParallelMultiHashMap<Entity, EFFECT_CTX> _effects;
        ...
        protected override void OnCreate()
        {
            ...
            _effects = new NativeParallelMultiHashMap<Entity, EFFECT_CTX>(0, Allocator.Persistent);
        }
        ...
        struct RemapEffects : IJobParallelFor
        {
            ...
            public NativeParallelMultiHashMap<Entity, EFFECT_CTX>.ParallelWriter EffectsWriter;
        ...
        {
            [ReadOnly] public NativeStream.Reader EffectReader;
            public NativeParallelMultiHashMap<Entity, EFFECT_CTX> Effects;
            public void Execute()
            {
                Effects.Clear();
        ...
        protected sealed override void OnUpdate()
        {
            ...
            NativeParallelMultiHashMap<Entity, EFFECT_CTX>.ParallelWriter effectsWriter = _effects.AsParallelWriter();
